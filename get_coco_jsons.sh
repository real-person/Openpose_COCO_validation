...
# for modelPath in ${SHARED_FOLDER}*.caffemodel; do
    ...
    finalJsonFile1=${JSON_FOLDER_1}${modelName}_1_${ImType}.json
    finalJsonFile1_foot=${JSON_FOLDER_1_foot}${modelName}_1_${ImType}.json
    temporaryJsonFile1=C:/Users/marsh/Desktop/temporaryJson_${EXPERIMENT}_${modelName}_1.json
    temporaryJsonFile1Foot=C:/Users/marsh/Desktop/temporaryJson_${EXPERIMENT}_${modelName}_1_foot.json
    ...
    if [ -f $finalJsonFile1 ]; then
        ...
        $OP_COMAND_1SCALE --image_dir ${IMAGE_DIR} --write_coco_json_variants 3 --model_folder "" # --net_resolution -1x480
